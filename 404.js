function display_404_in_en_us() {
    ...
    var data_line6 = document.getElementById("data_line6");
    ...
    data_line6.innerHTML = data_line6_data;
...
function display_404_in_zh_hant() {
    ...
    let data_line5_data = "XuPaperCup的網站";
    let data_line6_data = '<a href="https://pages.github.com/" target="_blank" id="powered">由&thinsp;<b>GitHub</b>&thinsp;Pages&thinsp;提供支持</a>';
